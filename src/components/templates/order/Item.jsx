        ...
        <section>
            {
                width > 640 && (
                    <div className="flex justify-between text-center mb-6">
                        ...
                        <div className="w-[20%]  text-green-600 font-semibold">Delivered</div>
                        <div className="w-[25%]">
                            <Button onClick={handleShowDetail} className={` bg-pink-600 text-white-50 p-1 rounded-sm `}>
                                View Details
                            </Button>
                        </div>
                ...
                (
                    <div className=" flex justify-between mb-6 border-b border-white-400 pb-3">
                        ...
                        <div>
                            ...
                            <div className="mb-3 text-green-600 font-bold">Success</div>
                            <div className="">
                                <Button onClick={handleShowDetail} className={` bg-pink-600 text-white-50 p-1 rounded-sm `}>
                                    View Details
                                </Button>
