...
const TopProducts = () => {
    ...
    const changeWidth =
        router.pathname === '/store' ? 'w-[220px]' : 'w-[300px]';
    ...
    return (
        <div>
            <div
                className={` bg-white-50 h-full tabletS:w-full ${changeWidth} rounded-md p-4 ${changeMargin3}`}
            >
                <Typography
                    variants={3}
                        ...
                        return (
                            <Link href={`/store/${slug}`} key={id}>
                                <div className={`mb-2 flex ${changeMargin2}`}>
                                    <div
                                        className={`relative w-[80px] h-[80px] me-4 ${changeMargin}`}
                                    >
                                        <Image
                                            src={image}
                                            fill={true}
                                    ...
                                    <div>
                                        <Typography
                                            variants={3}
                                            className={` text-sm text-white-950 mb-3`}
                                        >
                                            {formatTitle}
                                        </Typography>
                                        <div>
