    ...
    return (
        <section className="bg-white-50 shadow-md shadow-black-700 mx-8 p-8 mobileXL:px-4 mobileXL:mx-4 rounded-md">
            <div className="flex justify-between mb-8 text-xl mobileXL:text-lg mobileM:text-[12px] mobileM:font-bold ">
                <Typography
                    variants={3}
                    className={` hover:text-pink-600 transition duration-500 cursor-pointer ease-in-out`}
                >
                    <span>Your Cart </span>
                    <span>(3) </span>
                    <span> Items</span>
                ...
                <Link href={`/store`}>
                    <Typography
                        variants={3}
                        className={`cursor-pointer hover:text-pink-600 transition duration-500 ease-in-out`}
                        role="button"
                        title="Shop More"
                    >
                        Continue Shopping{' '}
