    ...
    return (
        <section className='flex tabletM:flex-col'>
            <div className='relative h-screen w-full tabletM:h-[150px]'>
                ...
                <Image src='/images/signup.svg' fill={true} priority={true} style={{ objectFit: 'contain' }} />
            </div>
                    ...
                    '>
                        ...
                        <div className='mt-2'>
                            <Typography variants={`3`} className={`text-white-50 text-center mt-2 font-bold  mobileM:text-[15px]`}>
                                Already have an account? <span className=' ms-2'><Link className='underline' href={`/auth/login`}>Login</Link></span>
                            </Typography>
                        </div>
