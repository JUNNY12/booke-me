        ...
        <div className="sidebar bg-white-100 z-40 fixed h-full rounded-tl-md w-[180px] top-0 right-0">
            ...
            <ul className="flex text-xl flex-col pt-40">
                <Link
                    href={`/`}
                    className={` ${
                        router.pathname == '/' ? ' text-pink-600 font-bold' : ''
                    } `}
                >
                    <li className="me-8 my-2 hover:text-pink-600 ms-6 transition duration-500 ease-in-out">
                        Home
                    </li>
                </Link>
                <Link
                ...
                >
                    <li className="me-8 my-2 ms-6 transition duration-500 ease-in-out hover:text-pink-600">
                        Store
                    </li>
                </Link>
                <Link
                ...
                <Link href={`/auth/login`}>
                    <li className=" ms-4 absolute bottom-2 ">
                        <Button
                            className={` bg-pink-600 rounded-[20px] text-center  p-[0.15rem] text-lg 
