    ...
    return (
        <FormProvider>
            <section className=' flex tabletM:flex-col'>
                <div className='relative h-screen w-1/2 tabletM:h-[150px] tabletM:w-full'>
                    <div className=' absolute left-1/2 top-1/2 text-center w-full transform -translate-x-1/2 -translate-y-1/2 z-20'>
                        <Typography variants={3}>
                            <span className='text-5xl tabletM:text-3xl mobileXL:text-2xl font-bold text-white-50'>Setup Address</span>
                        </Typography>
                    </div>
