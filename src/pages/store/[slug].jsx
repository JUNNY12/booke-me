                ...
                <section className="mx-8 tabletS:mx-4 bg-white-50">
                    ...
                    <div className=" p-12 tabletS:tabletS:p-4 rounded-md flex justify-center tabletS:flex-col items-center relative">
                        ...
                        <div className=" tabletS:flex tabletS:items-center tabletS:justify-center tabletS:flex-col">
                            <Typography variants="3" className="text-3xl tabletS:text-2xl mobileXL:text-xl mt-4 text-white-950 mb-4">
                                {book.title}
                            </Typography>
                    ...
                    <div className="flex tabletS:flex-col  justify-center p-8 tabletS:px-4 ">
                        <div className="w-2/5 tabletS:w-full me-8 tabletS:me-0">
                            <Typography variants="3" className="text-3xl font-semibold mobileM:text-2xl mt-4  text-white-950 mb-8">
                                Book Details
                            </Typography>
                            ...
                            <div className="">
                                <div className="">
                                    <div className="flex items-center mb-3 bg-white-50 p-2 border-t border-b border-dashed border-white-300">
                                        <div className=" w-[80px] text-white-950">Pages:</div>
                                        <div>500</div>
                                    </div>
                                    <div className="flex items-center mb-3 bg-white-100 p-2 border-t border-b border-dashed border-white-300">
                                        <div className=" w-[80px] text-white-950">Language:</div>
                                        <div>{book.language}</div>
                                    </div>
                                    <div className="flex items-center mb-3 bg-white-50 p-2 border-t border-b border-dashed border-white-300">
                                        <div className=" w-[80px] text-white-950"> Released:</div>
                                        <div>{book.publication_year}</div>
                                    </div>
                                    <div className="flex items-center mb-3 bg-white-100 p-2 border-t border-b border-dashed border-white-300">
                                        <div className=" w-[80px] text-white-950">Publisher:</div>
                                        <div>Lorem Ipsum</div>
                                    </div>

                                    <div className="flex items-center mb-3 bg-white-50 p-2 border-t border-b border-dashed border-white-300">
                                        <div className=" w-[80px] text-white-950">Genre:</div>
                                        <div>{book.genre}</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="w-3/5 tabletS:w-full tabletS:me-0">
                            ...
                            <div>
                                <Typography variants="4" className="text-xl mobileM:text-lg italic mt-2 text-white-950 mb-4">
                                    {book.author}
                                </Typography>
                                ...
                                <p>
                                    ...
                                    hic doloremque a ipsa ab deleniti reiciendis dolore
                                    expedita sapiente repellendus, eveniet debitis natus harum
                                    quam velit illo error nisi ducimus accusamus enim. Molestiae fuga in
                                    iure vitae ex dolore, nulla alias quos fugiat quas saepe est placeat.
                                </p>
                    ...
                    <div className="p-8 tabletS:px-4 ">
                        <div className="border-t border-b p-2 border-dashed rounded-md border-white-300 flex ">
                            <Typography variants="3"
                                ...
                                className={`text-3xl tabletXS:text-xl mobileXL:text-lg  cursor-pointer font-semibold hover:underline me-12 mt-4 mb-4 ${toggle ? "text-pink-600" : ' text-white-950'}`}>
                                Description
                            </Typography>
                            <Typography
                                onClick={showReview}
                                variants="3" className={`text-3xl tabletXS:text-xl mobileXL:text-lg font-semibold cursor-pointer hover:text-pink-600 hover:underline mt-4  mb-4 ${!toggle ? 'text-pink-600' : ' text-white-950'}`}>
                                Reviews(2)
                            </Typography>
                        </div>
                        ...
                        <div>
                            {
                                toggle ? (
                                    ...
                                    <div>
                                        <div>
                                            {
                                                review.map((item) => {
                                                    ...
                                                    return (
                                                        <article key={item.id} className="border border-gray-200 rounded-md p-4 mt-4">
                                                            <div className="flex justify-between items-center">
                                                                <Typography variants="4" className="text-2xl mobileM:text-xl">
                                                                    {item.name}
                                                                </Typography>
                                                                <Typography variants="4" className="text-[14px] italic">
                                                                    {item.date}
                                                                </Typography>
                                                            </div>
                                                            ...
                                                            <div className="mt-4">
                                                                <Typography variants="4" className=" tracking-[2px] text-base">
                                                                    {item.comment}
                                                                </Typography>
                                                            </div>
                                                        </article>
                                        ...
                                        <div>
                                            <Typography variants="3" className="text-3xl font-semibold mobileM:text-2xl mt-8 text-white-950 mb-4">
                                                Add a review
                                            </Typography>
                                        </div>
                                        ...
                                        <div>
                                            <form className="flex flex-col">
                                                <div>
                                                    <Rate onRateClick={handleRateClick} />
                                                </div>
                                                ...
                                                <Button title="Submit" className="mt-4 p-2 rounded-sm w-full text-white-50 font-bold 
