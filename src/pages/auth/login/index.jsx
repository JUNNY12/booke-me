        ...
        <section className='flex tabletM:flex-col'>
            <div className='relative h-screen w-full tabletM:h-[100px]'>
                <div className=' absolute left-1/2 top-1/2 text-center w-full transform -translate-x-1/2 -translate-y-1/2 z-20'>
                    <Typography variants={3}>
                        <span className='text-5xl tabletM:text-3xl mobileXL:text-2xl font-bold text-white-50'>Welcome Back</span>
                    </Typography>
                </div>
                <div className='absolute top-0 left-0 w-full h-full tabletM:h[70px] bg-[#00000088] z-10'></div>
                <Image src='/images/login.svg' fill={true} priority={true} style={{ objectFit: 'contain' }} />
            </div>
            <div className="h-[100vh] tabletM:h-max bg-white-100 bg-cover relative w-full px-4 py-3">
                ...
                <div className='flex justify-center items-center'>
                    <form action="" className='w-[400px] mobileXL:wfull rounded-md h-max mt-8 mobileXL:mt-4
                    ...
                    '>
                        ...
                        <Typography variants={`1`} className={`text-2xl font-bold mb-6 text-white-50 text-center`}>
                            Login
                        </Typography>
                        ...
                        <div className=' flex justify-between items-center mb-3 text-white-50 font-bold'>
                            <div className='w-[150px]  mobileM:w-[125px] '>
                                <input
                                    ...
                                    type='checkbox'
                                />
                                <label htmlFor="remember" className=' mobileM:text-[14px]'>Remember Me</label>
                            </div>
                            <Link href={`/`}>
                        ...
                        <div className='mt-2'>
                            <Typography variants={`3`} className={`text-white-50 text-center mt-2 font-bold  mobileM:text-[15px]`}>
                                Don't have an account? <span className=' ms-2'><Link className='underline' href={`/auth/register`}>Sign Up</Link></span>
                            </Typography>
                        </div>
